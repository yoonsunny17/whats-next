  ...
  return (
    <div className="relative group">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 hover:border-2 hover:border-main transition-opacity duration-400">
